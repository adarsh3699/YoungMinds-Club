...
const internshipSchema = new mongoose.Schema({
    ...
    type: {
        ...
        enum: ['Full-time', 'Part-time', 'Remote', 'Hybrid', 'On-site', 'Project-based', 'Research', 'Summer', 'Winter', 'Other']
    },
    tags: [{
        type: String,
        trim: true
    ...
    category: {
        ...
        enum: ['Technology', 'Business', 'Marketing', 'Design', 'Finance', 'Engineering', 'Data Science', 'Content', 'HR', 'Legal', 'Healthcare', 'Education', 'Research', 'Consulting', 'Nonprofit', 'Media', 'Other']
    },
    startDate: {
        type: Date,
