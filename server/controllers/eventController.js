...
exports.registerForEvent = async (req, res) => {
    ...
    try {
        ...
        const alreadyRegistered = userActivity.registeredEvents.some(
...
exports.saveEvent = async (req, res) => {
    try {
        ...
        const alreadySaved = userActivity.savedEvents.some(
            saved => saved.event.toString() === eventId
        );
        
        if (alreadySaved) {
            // Remove from saved events if already saved
            userActivity.savedEvents = userActivity.savedEvents.filter(
                saved => saved.event.toString() !== eventId
            );
...
exports.submitFeedback = async (req, res) => {
    try {
        ...
        const registeredEventIndex = userActivity.registeredEvents.findIndex(
            reg => reg.event.toString() === eventId
        );
