...
const EventDetails: React.FC = () => {
	...
	return (
		<div className="min-h-screen ym-features-bg">
			...
			{/* Draft/Flagged Event Notice */}
			{event && (!event.isPublished || event.isFlagged) && (
								...
								<p className="text-sm text-warning">
									{!event.isPublished && (
										<span className="font-medium">
											This is a draft event and is not visible to the public.
										</span>
									)}
									{event.isFlagged && (
										<span className="font-medium">
											This event has been flagged by administrators.
											{event.flagReason && ` Reason: ${event.flagReason}`}
										</span>
									)}
								</p>
							</div>
