    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="bg-white p-6 rounded-lg shadow-md text-center">
          ...
          <p className="text-gray-600 mb-6">You haven't saved or registered for any events yet.</p>
          <Link 
            to="/dashboard" 
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-8">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-6">
          ...
          <div className="flex-grow">
            ...
            <div className="flex items-center">
              ...
              {userActivity.streakCount > 0 && (
                <span className="ml-2 px-3 py-1 bg-yellow-100 text-yellow-800 rounded-full text-sm font-medium flex items-center">
          ...
          <div className="md:w-1/3 w-full">
            <h2 className="text-lg font-semibold text-gray-800 mb-2">Your XP Progress</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 border-t border-gray-200 pt-6">
          <div className="text-center">
            <p className="text-3xl font-bold text-indigo-600">{userActivity.registeredEvents.length}</p>
            <p className="text-gray-600">Registered Events</p>
          </div>
          <div className="text-center">
            <p className="text-3xl font-bold text-indigo-600">{userActivity.savedEvents.length}</p>
            <p className="text-gray-600">Saved Events</p>
          </div>
          <div className="text-center">
            <p className="text-3xl font-bold text-indigo-600">{userActivity.xp}</p>
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8">
        <div className="flex border-b">
          <button
            className={`py-4 px-6 text-lg font-medium flex-1 text-center ${
            ...
            <div>
              {userActivity.registeredEvents.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <h3 className="text-xl font-medium text-gray-700 mb-2">No registered events</h3>
                            ...
                            <div className="flex items-center mt-1">
                              {[...Array(5)].map((_, i) => (
                                <svg 
                                  ...
                                  className={`h-4 w-4 ${i < event.feedback.rating ? 'text-yellow-500' : 'text-gray-300'}`}
                                  viewBox="0 0 20 20"
                                  fill="currentColor"
                                >
            ...
            <div>
              {userActivity.savedEvents.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <h3 className="text-xl font-medium text-gray-700 mb-2">No saved events</h3>
                  <p className="text-gray-600 mb-4">You haven't saved any events for later.</p>
                  <Link 
                    to="/dashboard" 
                    className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-6 rounded transition-colors"
                  >
                  ...
                  {formatEvents(userActivity.savedEvents).map((event) => (
                    <div key={event._id} className="relative">
                      <button
                        ...
                        className="absolute top-2 right-2 z-10 bg-white rounded-full p-1 shadow-md text-gray-600 hover:text-red-600"
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {leaderboard.map((item, index) => (
              <tr key={index} className={index < 3 ? 'bg-yellow-50' : ''}>
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="text-sm text-gray-900 font-bold">{item.xp} XP</div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
