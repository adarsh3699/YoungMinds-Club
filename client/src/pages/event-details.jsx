        ...
        <div className="md:w-1/2 lg:w-2/5">
          ...
          <div className="mt-6 flex flex-col gap-3 md:hidden">
            {!isRegistered ? (
              ...
              <button
                disabled
                className="w-full bg-green-600 text-white py-3 px-4 rounded-lg font-medium cursor-default flex items-center justify-center"
              >
                Registered
              </button>
            )}
              ...
              {isSaved ? (
                <>
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M5 2a1 1 0 011 1v1h8V3a1 1 0 112 0v1h1a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V6a2 2 0 012-2h1V3a1 1 0 011-1zm11 7H4v8h12V9z" clipRule="evenodd" />
                  </svg>
                  Saved
                </>
              ) : (
        ...
        <div className="md:w-1/2 lg:w-3/5">
          <div className="mb-4">
            <div className="flex items-start justify-between">
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-white mb-2">{event.title}</h1>
                <p className="text-gray-600 dark:text-gray-300 mb-3">{event.shortDescription}</p>
              </div>
          ...
          <div className="hidden mb-8 md:flex gap-3">
            {!isRegistered ? (
              <button
                onClick={handleRegister}
                className="bg-blue-600 hover:bg-blue-700 text-white py-2 px-6 rounded-lg font-medium transition-colors flex items-center"
              >
                Register Now
              </button>
            ) : (
              <button
                disabled
                className="bg-green-600 text-white py-2 px-6 rounded-lg font-medium cursor-default flex items-center"
              >
                Registered
              </button>
            )}
            ...
            tabs={[
              {
                ...
                content: (
                  <div className="space-y-6">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-2">Date & Time</h3>
                    ...
                    {event.registrationDeadline && (
                      <div>
                        <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-2">Registration Deadline</h3>
                        <div className="flex items-center text-gray-600 dark:text-gray-400">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-gray-500 dark:text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                content: (
                  <div className="space-y-6">
                    <div className="flex items-center mb-4">
                      <div className="h-12 w-12 rounded-full bg-indigo-100 dark:bg-indigo-900 flex items-center justify-center overflow-hidden mr-4">
                      ...
                      <div>
                        <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">{event.organizer.name}</h3>
              ...
              },
              {
                ...
                content: (
                  <div className="space-y-6">
                    <p className="text-gray-600 dark:text-gray-400">Share this event with friends and colleagues:</p>
                    ...
                    <div className="flex flex-wrap gap-4">
                      ...
                      <button
                        ...
                        className="flex items-center bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 py-2 px-4 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors"
                      >
                        <svg className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="mt-8 bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">Registration Status</h3>
