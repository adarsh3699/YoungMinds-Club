...
import { EventFeedbackData, FeedbackApiResponse, UserEventsApiResponse, ApiResponse } from "@/types";
	...
	useEffect(() => {
		const fetchEventDetails = async (): Promise<void> => {
			...
			try {
				...
				const eventResponse: AxiosResponse<ApiResponse<{ event: EventFeedbackData }>> = await axios.get(
					`/events/${id}`
				);
				...
				const isRegistered = userEventsResponse.data.registeredEvents.some((event) => event.id === id);
				...
				<div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
					<div className="text-center">
						...
						<p className="text-gray-600 mb-6">
							Your feedback has been submitted successfully and will help improve future events.
						</p>
		...
		<div className="container mx-auto px-4 py-12">
			<div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
				...
				<form onSubmit={handleSubmit}>
					...
					{/* Rating */}
					<div className="mb-8">
						<label className="block text-gray-700 font-semibold mb-2">Rate this event (required)</label>
