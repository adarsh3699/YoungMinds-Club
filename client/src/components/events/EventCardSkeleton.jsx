...
const EventCardSkeleton = () => {
  return (
    <div className="relative rounded-xl overflow-hidden">
      {/* Card Container */}
      <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-md flex flex-col h-full animate-pulse">
        {/* Image placeholder */}
        <div className="relative h-52 bg-gray-300 dark:bg-gray-700">
          ...
          <div className="absolute bottom-3 right-3 z-10">
            <div className="h-6 w-14 bg-gray-400 dark:bg-gray-600 rounded-lg"></div>
          </div>
        </div>
        ...
        <div className="p-4 flex-grow flex flex-col">
          ...
          <div className="flex justify-between items-start mb-4">
            ...
            <div className="w-5 h-5 bg-gray-300 dark:bg-gray-700 rounded-sm ml-2"></div>
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="flex space-x-2">
              {[...Array(4)].map((_, i) => (
                <div key={i} className="h-10 bg-gray-300 dark:bg-gray-700 rounded w-1/4"></div>
              ))}
            </div>
          </div>
          ...
          <div className="space-y-2 mb-4">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="flex items-center">
                <div className="w-4 h-4 mr-2 bg-gray-300 dark:bg-gray-700 rounded-full"></div>
          ...
          <div className="mt-auto">
            ...
            <div className="w-full h-2 bg-gray-300 dark:bg-gray-700 rounded-full mb-2"></div>
