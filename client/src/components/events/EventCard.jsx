...
const EventCard = ({ 
  ...
  const handleSaveToggle = (e) => {
    ...
    if (onSaveToggle) {
      onSaveToggle(event._id, !isSaved);
    }
  };
  ...
  return (
    ...
    >
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 flex flex-col h-full">
        ...
        <Link to={`/event/${event._id}`} className="block relative h-52 overflow-hidden">
          <img 
        ...
        <div className="p-4 flex-grow flex flex-col">
          ...
          <div className="flex justify-between items-start mb-2">
            <Link to={`/event/${event._id}`} className="flex-grow">
            ...
            <div className="mb-3">
              ...
              <div className="flex space-x-2">
                <div className="bg-indigo-50 dark:bg-indigo-900/30 px-2 py-1 rounded text-center min-w-[40px]">
                  <span className="text-indigo-700 dark:text-indigo-300 text-sm font-bold">{countdown.days}</span>
                  <p className="text-gray-500 dark:text-gray-400 text-xs">days</p>
                </div>
                <div className="bg-indigo-50 dark:bg-indigo-900/30 px-2 py-1 rounded text-center min-w-[40px]">
                  <span className="text-indigo-700 dark:text-indigo-300 text-sm font-bold">{countdown.hours}</span>
                  <p className="text-gray-500 dark:text-gray-400 text-xs">hrs</p>
                </div>
                <div className="bg-indigo-50 dark:bg-indigo-900/30 px-2 py-1 rounded text-center min-w-[40px]">
                  <span className="text-indigo-700 dark:text-indigo-300 text-sm font-bold">{countdown.minutes}</span>
                  <p className="text-gray-500 dark:text-gray-400 text-xs">mins</p>
                </div>
                <div className="bg-indigo-50 dark:bg-indigo-900/30 px-2 py-1 rounded text-center min-w-[40px]">
                  <span className="text-indigo-700 dark:text-indigo-300 text-sm font-bold">{countdown.seconds}</span>
