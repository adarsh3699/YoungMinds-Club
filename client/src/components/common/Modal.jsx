      ...
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className={`w-full ${maxWidth} transform overflow-hidden rounded-lg bg-white dark:bg-gray-800 ${noPadding ? 'p-0' : 'p-6'} text-left align-middle shadow-xl transition-all ${contentClassName}`}>
                {title && !noPadding && (
                ...
                <div className={title && !noPadding ? 'mt-4' : ''}>
                  {children}
                </div>
              </Dialog.Panel>
            </Transition.Child>
