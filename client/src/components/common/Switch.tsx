...
import { SwitchProps, SwitchChangeEvent } from '@/types';
...
const Switch: React.FC<SwitchProps> = ({
	...
	const [internalEnabled, setInternalEnabled] = useState<boolean>(false);
	...
	// Size-based styling
	const sizeClasses: Record<'small' | 'default' | 'large', { switch: string; ring: string; translate: string }> = {
		small: {
			switch: 'h-5 w-9',
			ring: 'h-3 w-3',
